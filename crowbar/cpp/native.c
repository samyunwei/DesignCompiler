...
CRB_Value new_array_sub(CRB_Interpreter *inter, LocalEnvironment *env, int arg_count, CRB_Value *args, int arg_index) {
    CRB_Value ret;
    int size;
    int i;
...
CRB_Value crb_nv_new_array_proc(CRB_Interpreter *interpreter, LocalEnvironment *env, int arg_count, CRB_Value *args) {
    CRB_Value value;
